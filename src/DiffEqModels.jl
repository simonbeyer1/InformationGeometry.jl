...
function DataModel(DS::AbstractDataSet, sys::SciMLBase.AbstractDiffEqFunction, u0::Union{AbstractArray{<:Number},Function},
    ...
    DataModel(DS, GetModel(sys, u0, observables; tol=tol, Domain=Domain, kwargs...), args...)
end
